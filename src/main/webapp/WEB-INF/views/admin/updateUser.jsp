...
<div class="container-wrapper">
	<div class="container">
		<div id="login-box">
			...
			<form name="updateForm" action="<c:url value="/admin/updateUser"/> "
				...
				<div class="form-group">
					<label for="username">Use Name</label> <input type="text"
						id="username" name="userName" class="form-control" value="${user.userName}"/>
				</div>
				<!-- 
				<div class="form-group">
					<label for="password">Password</label> <input type="password"
						id="password" name="password" class="form-control" value="${user.password}"/>
				</div>
				 -->
				<div>
